        ...
        {quickPrompts.map((item, index) => (
          <div key={index} className="contents">
            <motion.button
              ...
              className="flex items-center gap-1.5 rounded-full border border-[#bdb3a5]/20 bg-[#fcf9f8] px-3 py-1.5 font-body text-xs text-[#4e3c30] transition hover:bg-white hover:text-[#8B6F47]"
            >
              <span>{item.icon}</span>
              <span>{item.text}</span>
            </motion.button>
